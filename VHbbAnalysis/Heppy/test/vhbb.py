...
class FilterAnalyzer( Analyzer ):
    def process(self, event):
        ...
        return (nlep>=1) and (njet >= 2)

filterAna = cfg.Analyzer(FilterAnalyzer)
...
#root://stormgf1.pi.infn.it:1094//store/mc/RunIISpring16MiniAODv2/TT_TuneCUETP8M1_13TeV-powheg-pythia8/MINIAODSIM/PUSpring16_80X_mcRun2_asymptotic_2016_miniAODv2_v0_ext4-v1/00000/E8090432-8628-E611-8713-001EC9ADFDC9.root",
		...
		"root://cmsxrootd.fnal.gov//store/mc/RunIISummer16MiniAODv2/ttbb_4FS_OpenLoops_13TeV-sherpa/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/50000/2E88C43E-4B26-E711-908E-842B2B17F557.root",
